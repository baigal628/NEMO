...
if args.save_test:
    torch.save(val_dataset, f'{args.outpath}/val_dataset_{args.exp_id}_{args.model_type}.pt')
    torch.save(train_dataset, f'{args.outpath}/train_dataset_{args.exp_id}_{args.model_type}.pt')
